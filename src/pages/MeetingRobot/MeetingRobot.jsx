...
const MeetingRobot = () => {
  ...
  const handleEndCall = () => {
    ...
    // التنقل إلى صفحة التقييم عند إنهاء المكالمة
  ...
  />
      ...
      <div className="meeting-controls">
        ...
        <div className="controls-center">
          ...
          >
            <svg viewBox="0 0 24 24" fill="none">
              <path d="M18 11V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v5M14 10V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v6M10 10.5V6a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v8c0 .796-.316 1.559-.879 2.121l-.707.708a1 1 0 0 0-.293.707V21a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5.5M18 11a2 2 0 1 1 4 0v3a8 8 0 0 1-8 8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          ...
          >
            <svg viewBox="0 0 24 24" fill="none">
              <path d="M23 16.92V21a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 5.11 3h4.09a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 12.1a16 16 0 0 0 6 6l2.47-2.35a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2z" fill="currentColor"/>
            </svg>
            <span>End Call</span>
          </button>
        </div>
        ...
        <div className="controls-right">
          ...
          <button className="control-button whatsapp-button" title="WhatsApp">
